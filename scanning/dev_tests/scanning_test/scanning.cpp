...
//filter function
pcl::PointCloud<pcl::PointXYZRGBA>Ptr filterCloud (pcl::PointCloud<pcl::PointXYZRGBA>Ptr input_cloud, pcl::PointCloud<pcl::PointXYZRGBA>Ptr filtered_Cloud)
{
...
int main (int argc, char** argv) {
  ...
  if ( argc > 4 ) {
	...
	pcl::PointCloud<pcl::PointXYZRGBA>::Ptr cloud_4o;
  pcl::PointCloud<pcl::PointXYZRGBA>::Ptr cloud_8o;
  pcl::PointCloud<pcl::PointXYZRGBA>::Ptr cloud_12o;

  cloud_4o = filterCloud(cloud_4o_orig);
  cloud_8o = filterCloud(cloud_8o_orig);
  cloud_12o = filterCloud(cloud_12o_orig);
